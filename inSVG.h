...
/*Le as informacoes de texto do arquivo .geo e armazena na lista figuras*/
...
/*Le os parametros de consulta do comando "pnt"*/
void scanPnt(FILE *arqQuery, char j[], char corb[], char corp[]);

/*Le os parametros de consulta do comando "pnts"*/
...
void scanDQ(FILE *arqQuery, bool *dq, char id[], double *r);

/*Le os parametros de consulta do comando "car"*/
